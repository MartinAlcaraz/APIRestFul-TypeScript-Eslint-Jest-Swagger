...
export default class ApiFeatures {
    ...
    // devuelve los campos solicitados. Ej: name price description
    limitFields () {
    ...
    async pagination () {
        ...
        if (this.queryString.page) {
            ...
            const count = await User.find(this.query)
